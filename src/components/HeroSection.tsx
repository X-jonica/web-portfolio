    ...
    <section id="hero" className="min-h-screen pt-16 flex items-center">
      <div className="container flex flex-col-reverse lg:flex-row items-center gap-12">
        ...
        >
          ...
          >
            Bonjour, je suis <span className="text-gradient">Jonica Henintsoa</span>
          </motion.h1>
          <motion.p 
          ...
          >
            Je conçois et développe des applications web modernes avec passion, en utilisant les technologies les plus récentes pour créer des expériences utilisateur exceptionnelles.
          </motion.p>
          <motion.div 
