...
import { ChevronLeft, ChevronRight, Download, Github, Linkedin, Mail } from 'lucide-react';
...
export function Hero() {
  ...
  const prevSlide = () => {
    setCurrentIndex((prev) => (prev - 1 + PROFILE_IMAGES.length) % PROFILE_IMAGES.length);
    setIsAutoPlaying(false);
  };
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center py-20 px-4 md:px-8">
